...
namespace apiclean.Application.Services.Auth
{
    public class TokenService : ITokenService
    {
        ...
        {
            var issuer = _configuration["JwtSettings:Issuer"] ?? "ApiClean";
            var audience = _configuration["JwtSettings:Audience"] ?? "ApiCleanUser";
